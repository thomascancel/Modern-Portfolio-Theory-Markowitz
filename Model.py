...
class Model:
    ...
    def display_ef_with_selected(self):
        ...
        plt.gca().xaxis.set_major_formatter(PercentFormatter(1))
        plt.title("Portfolios allocation max sharpe ratio")
        plt.xlabel('Weights')
        plt.ylabel('Stocks')
        ...
        plt.gca().xaxis.set_major_formatter(PercentFormatter(1))
        plt.title("Portfolios allocation max sharpe ratio for weight less than 15%")
        plt.xlabel('Weights')
        plt.ylabel('Stocks')
        ...
        plt.gca().xaxis.set_major_formatter(PercentFormatter(1))
        plt.title("Portfolios allocation min volatility")
        plt.xlabel('Weights')
        plt.ylabel('Stocks')
